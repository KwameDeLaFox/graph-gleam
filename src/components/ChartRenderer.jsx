        ...
        <div className="mt-4 p-4 bg-muted/50 rounded-lg border border-border">
          <div className="flex flex-wrap items-center justify-between gap-4 text-sm">
            ...
            <div className="flex items-center gap-2">
              <button
                onClick={() => {
                  if (ref?.current?.exportChart) {
                    ref.current.exportChart('png', `chart-${chartType}`);
                  }
                }}
              ...
              <button
                onClick={() => {
                  if (ref?.current?.exportChart) {
                    ref.current.exportChart('jpeg', `chart-${chartType}`);
                  }
                }}
              ...
              <button
                onClick={() => {
                  if (ref?.current?.getEmbedCode) {
                    const embedCode = ref.current.getEmbedCode();
